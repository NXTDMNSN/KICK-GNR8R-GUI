...
from KICK_GNR8R.base.model import ModelWrapperBase
from KICK_GNR8R.base.type import ModelType


class KICKGNR8RInference(nn.Module):
    def __init__(self, n_attn_layers:int = 4, **kwargs):
        super().__init__()

        self.diffusion_ema = DiffusionAttnUnet1D(kwargs, n_attn_layers=n_attn_layers)

class KGModelWrapper(ModelWrapperBase):
    def __init__(self):
        
        super().__init__()
        
        self.module:KICKGNR8RInference = None
    ...
    def load(
        ...
        self.module = KICKGNR8RInference(
