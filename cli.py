...
from KICK_GNR8R.api import RequestHandler, Request, Response, RequestType, ModelType
...
def parse_cli_args():
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="models/KG/model.ckpt",
        help="Path to the model checkpoint file to be used (default: models/KG/model.ckpt)."
    )
    parser.add_argument(
        "--model_type",
        type=ModelType,
        choices=ModelType,
        default=ModelType.KG,
        help="The model type."
    )
    parser.add_argument(
        "--sample_rate",
    ...
    parser.add_argument(
        ...
        type=json.loads,
        default={},
        help="Additional arguments of the KG sampler."
    )
    parser.add_argument(
        "--schedule",
        type=SchedulerType,
    ...
    parser.add_argument(
        ...
        type=json.loads,
        default={},
        help="Additional arguments of the KG schedule."
    )
    parser.add_argument(
        "--inpaint_args",
        type=json.loads,
