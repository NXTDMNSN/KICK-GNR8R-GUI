...
from gnr8r.base.model import ModelWrapperBase
from gnr8r.base.type import ModelType


class gnr8rInference(nn.Module):
...
class DDModelWrapper(ModelWrapperBase):
    def __init__(self):
        ...
        self.module:gnr8rInference = None
